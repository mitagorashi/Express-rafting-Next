        ...
        <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
          ...
          <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
            <nav className="navbar8-links1">
              <Link href="/">
                <a className="navbar8-link10 thq-link thq-body-small">
                  {props.link1 ?? (
                    <Fragment>
                      <span className="navbar8-text16">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_QKSU7r'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.link21 ?? (
                    <Fragment>
                      <span className="navbar8-text14">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_7VQAQV'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
              ...
              <a
                href="https://www.instagram.com/expressrafting?utm_source=ig_web_button_share_sheet&amp;igsh=ZDNlZDc0MzIxNw=="
                target="_blank"
                ...
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar8-text28">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_WzRCeg'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
                    ...
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text19">
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_hu1AWd'),
                            }}
                          ></span>
                        </span>
                      </Fragment>
            ...
            <div className="navbar8-buttons1">
                  ...
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text18">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_MiibIH'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
              ...
              <Link href="/contact">
                <a className="navbar8-link14 thq-button-outline thq-button-animated">
                  <span>
                    {props.action2 ?? (
                      <Fragment>
                        <span className="navbar8-text15">
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_iCSGzL'),
                            }}
                          ></span>
                        </span>
                      </Fragment>
          ...
          <div data-thq="thq-mobile-menu" className="navbar8-mobile-menu">
            <div className="navbar8-nav">
              ...
              <nav className="navbar8-links2">
                <a
                  href={props.link1Url}
                  className="navbar8-link15 thq-link thq-body-small"
                >
                  {props.link1 ?? (
                    <Fragment>
                      <span className="navbar8-text16">
                  ...
                  {props.link2 ?? (
                    <Fragment>
                      <span className="navbar8-text22">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_KilfNO'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                              ...
                              {props.page1 ?? (
                                <Fragment>
                                  <span className="navbar8-text21">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_LJuZ6y'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
                              ...
                              {props.page1Description ?? (
                                <Fragment>
                                  <span className="navbar8-text24">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_7GFLQI'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
                              ...
                              {props.page2 ?? (
                                <Fragment>
                                  <span className="navbar8-text25">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_6s-BdV'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
                              ...
                              {props.page2Description ?? (
                                <Fragment>
                                  <span className="navbar8-text17">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_PaMFPe'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
                              ...
                              {props.page3 ?? (
                                <Fragment>
                                  <span className="navbar8-text26">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_-jFxmD'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
                              ...
                              {props.page3Description ?? (
                                <Fragment>
                                  <span className="navbar8-text27">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_CCYiSI'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
                              ...
                              {props.page4 ?? (
                                <Fragment>
                                  <span className="navbar8-text23">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_cdbSFY'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
                              ...
                              {props.page4Description ?? (
                                <Fragment>
                                  <span className="navbar8-text20">
                                    <span
                                      dangerouslySetInnerHTML={{
                                        __html: translate.raw('text_LIbDTx'),
                                      }}
                                    ></span>
                                  </span>
                                </Fragment>
...
Navbar8.defaultProps = {
  link21: undefined,
  page4ImageSrc:
    'https://www.instagram.com/expressrafting?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
  action2: undefined,
  ...
  page1: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1664223308282-dcb887e70b49?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzQ4NDI5MHw&ixlib=rb-4.1.0&q=80&w=1080',
  page3ImageAlt: 'Adventure on the River',
  linkUrlPage2: 'https://www.teleporthq.io',
  link3Url: 'https://www.teleporthq.io',
  link2: undefined,
  logoSrc: '/express-1500h.jpg',
  linkUrlPage4: 'https://www.teleporthq.io',
  page4: undefined,
  page1ImageAlt: 'Rafting Adventure',
  page1Description: undefined,
  page2: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1677256796269-3c1a9d3fb14d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzQ4NDI5MHw&ixlib=rb-4.1.0&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  page3: undefined,
  linkUrlPage1: 'https://www.teleporthq.io',
  page3Description: undefined,
  logoAlt: 'Express Rafting Logo',
  page2ImageAlt: 'Team of Guides',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1601509876296-aba16d4c10a4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzQ4NDI4OHw&ixlib=rb-4.1.0&q=80&w=1080',
